...
<div class="row">
            ...
            <div class="card h-100 shadow-sm border-0">
                ...
                <div class="card-footer bg-white border-0 pb-3">
                    @if($item->status !== 'dikembalikan')
                        <a href="{{ route('items.show', $item->id) }}" class="btn btn-outline-primary btn-sm w-100">Ajukan Klaim / Lihat Detail</a>
                    @else
    ...
    @empty
        <div class="col-12 text-center py-5">
            <h5 class="text-muted">Belum ada laporan barang saat ini.</h5>
        </div>
    @endforelse
</div>
@endsection
